...
def test_train_resume(tmp_path, cfg_train):
    ...
    with open_dict(cfg_train):
        cfg_train.trainer.max_epochs = 1
        cfg_train.trainer.strategy = "ddp_find_unused_parameters_true"
    ...
    assert metric_dict_1["train/acc@1"] < metric_dict_2["train/acc@1"]
    assert metric_dict_1["val/acc@1"] < metric_dict_2["val/acc@1"]
